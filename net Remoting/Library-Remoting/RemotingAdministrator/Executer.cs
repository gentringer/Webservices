...
namespace RemotingAdministrator
{
    class Executer
    {
        public static int Main(string[] args)
        {
            ...
            String livree = admin.Createlivre("Gilles", "Gilles trop fort", "isbn", "gillesedit", "12");
            String livree2 = admin.Createlivre("Gilles2", "Gilles2 trop fort", "Gilles2", "Gilles2edit", "15");
